...
import { fetchLatestWorkoutProgramData, fetchWorkoutProgramData } from "@/utils/video/workoutVideoCollection";
...
const ProgramPage = () => {
    ...
    useEffect(() => {
        const getWorkoutProgram = async () => {
            const [workoutProgram, topics] = await Promise.all([fetchLatestWorkoutProgramData(), fetchAllTopic()]);
