        ...
        <div>
            ...
            <div className='h-full mx-auto mt-10'>
                <div className='flex justify-between mb-10'>
                    ...
                    <text className='flex text-[#303033] items-center cursor-pointer'>Sort By<Image src="/moredown.svg" alt="moredown" width={10.72} height={10}></Image></text>
                </div>
            </div>
            <div>
...
export default EasyBreakfastHeader
