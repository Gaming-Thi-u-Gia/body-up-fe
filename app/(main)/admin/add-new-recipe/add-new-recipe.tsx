    ...
    const handleAddNote = (e: React.MouseEvent<HTMLButtonElement>) => {
      ...
      if (recipe.noteRecipes.some((note) => note.detail === "")) {
        setErrors((prevErrors) => ({
          ...prevErrors,
          noteRecipes: "Please fill in all note details before adding a new note.",
        }));
        return;
      }
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      const checkEmptyFields = () => {
        ...
        if (recipe.prepTime <= 0) {
          setErrors((prevErrors) => ({
            ...prevErrors,
            prepTime: "Please fill in the prep time and ensure it is greater than 0.",
          }));
          hasError = true;
        }
        ...
        if (recipe.cookTime <= 0) {
          setErrors((prevErrors) => ({
            ...prevErrors,
            cookTime: "Please fill in the cook time and ensure it is greater than 0.",
          }));
          hasError = true;
        }
      ...
      <div className="container mx-auto py-12">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            />
            {errors.cookingInstruction && <p className="text-red-500">{errors.cookingInstruction}</p>}
          </div>
          <div>
            ...
            <div className="space-y-4">
              ...
              {errors.ingredientRecipes && <p className="text-red-500">{errors.ingredientRecipes}</p>}
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              {errors.noteRecipes && <p className="text-red-500">{errors.noteRecipes}</p>}
              <div className="flex items-center">
