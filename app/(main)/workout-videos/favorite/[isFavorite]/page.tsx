            ...
            <div className="gap-2 py-3">
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col bg-gray-200 items-center justify-center rounded-3xl py-16 gap-3">
                        <img src="https://chloeting.com/_next/static/media/no-fav-video-matching.40e0de3c.svg" alt="" className="w-[222px] h-[160px]"/>
                        <h1 className="text-xl font-semibold">No Favorite Videos Found</h1>
                        <p className="text-lg max-w-xl text-center">It looks like you don't have any saved videos yet. Click the heart button on a video to add it to your favorites!</p>
                        <Button className='mt-4' variant='primaryOutline' size='lg'>
                            <Link href="/workout-videos">Back to Workout Library Home</Link>
                        </Button>
                    </div>
                )}
