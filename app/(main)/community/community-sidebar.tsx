...
const CommunitySideBar = () => {
   ...
   return (
      <div className=" flex fixed top-[115px] left-0 w-[17.8%] flex-col border-r border-gray-200 h-[calc(100vh-110px)] z-20">
                        ...
                        >
                           ...
                           >
                              <Image
                                 ...
                                 height={24}
                                 alt="logo"
                                 className={`${isActive && "brightness-600"}`}
                              />
                              {link.label}
                           </Link>
                        </li>
                     ...
                     return (
                        <li
                           ...
                           className={`w-[25%] h-full flex items-center justify-center group ${
                              isActives ? "rounded-full bg-[#EDEBF9]" : ""
                           }`}
                        >
                           <Link href={link.route}>
                              <Image
                                 ...
                                 height={24}
                                 alt="logo"
                                 className={`${isActives && " text-blue-500"}`}
                              ></Image>
                           </Link>
