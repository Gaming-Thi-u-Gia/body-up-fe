...
const CommunitySideBar = () => {
    ...
    return (
        <div className=" flex fixed top-[110px] left-0 min-w-[333px] flex-col border-r border-gray-200">
            <div className="flex size-full  flex-col h-screen gap-4 ">
                <nav className="flex-col h-[850px] justify-between md:flex md:gap-4 ">
