            ...
            <div className="w-[823px] mt-[5%]">
                ...
                <div className="w-full flex flex-col p-2 gap-2 hover:bg-[#f5f5f5] rounded-lg">
                    ...
                    <div className="text-[#303033] text-[16px] mt-2">
                        I started Chloe's programs in March. The first photo was
                        taken after a month of training. Unfortunately I didn't
                        think of taking a picture at the beginning. . I am very
                        inspired by the fact that for the first time in my life
                        my abs began to show up! I also count calories, if
                        that's important.
                    </div>
                    <div className="w-full flex items-center gap-4">
                        <div className="flex flex-col gap-1 w-[50%]">
                            ...
                            <Item
                                original="https://static.chloeting.com/users/66181662ed0fcedc0969bc7e/photos/66412e739810b23039b25727/fa318370-10a2-11ef-95aa-b9f652f19ec5.jpeg"
                                thumbnail="https://static.chloeting.com/users/66181662ed0fcedc0969bc7e/photos/66412e739810b23039b25727/fa318370-10a2-11ef-95aa-b9f652f19ec5.jpeg"
                                width={1000}
                                height={800}
                            >
                                {({ ref, open }) => (
                        ...
                        <div className="flex flex-col gap-1 w-[50%]">
                            ...
                            <Item
                                original="https://static.chloeting.com/users/66181662ed0fcedc0969bc7e/photos/6654dcb6b624db48640b02d3/03b54690-1c5e-11ef-a2e9-f78e7e898479.jpeg"
                                thumbnail="https://static.chloeting.com/users/66181662ed0fcedc0969bc7e/photos/6654dcb6b624db48640b02d3/03b54690-1c5e-11ef-a2e9-f78e7e898479.jpeg"
                                width={1000}
                                height={800}
                            >
                                {({ ref, open }) => (
