...
const PostFitness = () => {
    return (
        <div className="w-full mb-10 flex flex-col p-2 gap-2 bor">
            <div className="w-full flex justify-between items-center ">
                <div className="flex gap-2 items-center">
                    ...
                    />
                    <label
                        className="text-[#303033] text-sm font-bold"
                        htmlFor=""
                    >
                        stellaria
                    </label>
            ...
            <div className="text-[#303033] text-[16px] h-[48px] mt-2 line-clamp-2 ">
