...
const CommunityNavbar = () => {
   ...
   const handleSearch = () => {
      // Update Zustand store with the local state
   ...
   return (
      <div className="w-full fixed top-15 left-0 z-20 bg-[#F9F9FA] h-[57px] flex items-center border-b border-gray-200/100 ">
         <div className="w-[17.8%] flex items-center pr-[200px] pl-[15px] border-r border-gray-200/100 h-[57px]">
            <h1 className="text-[#303033] font-lg font-bold text-[20px] ">
               Community
            </h1>
         </div>
         <div className="flex items-center flex-row justify-between w-[45%] h-[34px] ml-[12.7%]">
